...
def run():
    ...
    with open("tests/test_data/audio/test_mono.mp3", "wb") as out_file:
    ...
    with open("tests/test_data/audio/test_stereo.mp3", "wb") as out_file:
        out_file.write(mp3_buffer.getvalue())
        mp3_buffer.seek(0)
    ...
    with open("tests/test_data/audio/test_stereo_16bit.wav", "wb") as out_file:
        out_file.write(numpy_to_wav(stereo_audio, sr, bit_depth=16).getvalue())

    with open("tests/test_data/audio/test_stereo_24bit.wav", "wb") as out_file:
        out_file.write(numpy_to_wav(stereo_audio, sr, bit_depth=24).getvalue())

    with open("tests/test_data/audio/test_stereo_32bit.wav", "wb") as out_file:
        out_file.write(numpy_to_wav(stereo_audio, sr, bit_depth=32).getvalue())

    with open("tests/test_data/audio/test_stereo_64bit.wav", "wb") as out_file:
        out_file.write(numpy_to_wav(stereo_audio, sr, bit_depth=64).getvalue())

    with open("tests/test_data/audio/test_quad.wav", "wb") as out_file:
        out_file.write(numpy_to_wav(four_channel_audio, sr).getvalue())

    with open("tests/test_data/audio/test_stereo.ogg", "wb") as out_file:
        out_file.write(numpy_to_ogg(stereo_audio, sr, safe=False).getvalue())

    with open("tests/test_data/audio/test_quad.ogg", "wb") as out_file:
