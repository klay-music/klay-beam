...
class DemucsSeparator:
    ...
    def __init__(
        ...
        """Separates a signal into its sources using demucs.
        ...
        # Disable shifts on CPU to improve performance
        self.shifts = shifts and torch.cuda.is_available()
        # Always split on CPU to manage memory
        self.split = True if self.device.type == "cpu" else split
